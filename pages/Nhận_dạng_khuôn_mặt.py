...
parser.add_argument('--face_detection_model', '-fd', type=str, default='E:/SPKT/NAM3_I/T4_XULYANHSO/ProjectCuoiKyXLAS/model/face_detection_yunet_2023mar.onnx', help='Path to the face detection model. Download the model at https://github.com/opencv/opencv_zoo/tree/master/models/face_detection_yunet')
parser.add_argument('--face_recognition_model', '-fr', type=str, default='E:/SPKT/NAM3_I/T4_XULYANHSO/ProjectCuoiKyXLAS/model/face_recognition_sface_2021dec.onnx', help='Path to the face recognition model. Download the model at https://github.com/opencv/opencv_zoo/tree/master/models/face_recognition_sface')
...
svc = joblib.load('E:/SPKT/NAM3_I/T4_XULYANHSO/ProjectCuoiKyXLAS/model/svc.pkl')
