...
background = cv2.imread("E:/SPKT/NAM3_I/T4_XULYANHSO/ProjectCuoiKyXLAS/NhanDangChuyenDong_Streamlit/background2.png")
background = cv2.cvtColor(background, cv2.COLOR_BGR2GRAY)
background = cv2.GaussianBlur(background, (21, 21), 0)

video = cv2.VideoCapture("E:/SPKT/NAM3_I/T4_XULYANHSO/ProjectCuoiKyXLAS/NhanDangChuyenDong_Streamlit/test/test3.avi")
